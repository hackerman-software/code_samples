...
#define  error_message(error) printf("error: " #error "\n")

// if not defined (used in headers to avoid multiple inclusion)
#ifndef MESSAGE
...
int main() {
    ...
    printf("%s\n", MESSAGE); // This is the message if not already defined.
